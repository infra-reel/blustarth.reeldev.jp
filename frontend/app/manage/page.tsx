...
export default function ManageTop() {
  return (
    <div>
      <h1 className="font-heading font-700 text-3xl tracking-widest text-white mb-8">DASHBOARD</h1>
      <div className="grid md:grid-cols-2 gap-4">
        {sections.map(s => (
          <Link key={s.href} href={s.href}
            ...
            <p className="font-heading font-700 text-cyan tracking-widest group-hover:text-white transition-colors">{s.label}</p>
