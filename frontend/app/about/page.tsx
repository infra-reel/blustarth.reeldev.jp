    ...
    <div className="circuit-bg min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="mb-14 border-l-2 border-cyan pl-6">
          <h2 className="font-heading font-semibold text-xl text-cyan tracking-widest mb-4">TEAM</h2>
        ...
        {members.length > 0 && (
          <section>
            <h2 className="font-heading font-semibold text-xl text-cyan tracking-widest mb-6">MEMBERS</h2>
            <div className="grid md:grid-cols-2 gap-4">
              {members.map((m: any) => (
                <div key={m.id} className="flex gap-4 p-4 bg-navy/40 border border-white/5">
                  ...
                  <div>
                    <p className="font-heading font-bold text-white text-base">{m.name}</p>
